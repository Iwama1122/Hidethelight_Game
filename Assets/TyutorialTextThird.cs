...
namespace NovelGame
{
    public class TyutorialTextThird : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            switch (TyutorialManagerThird.Instance.lineNumber)
            {
                case 0:
                    NameText.text = "帽子屋";
                    Alice.SetActive(false);
        ...
        {
            string sentence = TyutorialManagerThird.Instance.userScriptManagerthird.GetCurrentSentence();
        ...
        public void GoToTheNextLine()
        {
            ...
            TyutorialManagerThird.Instance.lineNumber++;
        }
